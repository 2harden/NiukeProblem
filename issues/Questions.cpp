...
// 将32769赋值给short变量i时，由于i长度是2字节，发生截断赋值，只将低16位赋值给i，高16位溢出舍弃，
// 所以i的补码是10000000 00000001，则原码是11111111 11111111，值是-32767
...
// 解析：
// AC没啥讲的，p[1]等价于*(p+1)，B为什么要转成Int*，二维数组的本质还是一维数组，从p，a[0][0]到a[1][3]所跨越的刚好是7个整型长度。
// 为啥是7个？第二行第四列。D明显没有解引用
